...
export default function App() {
  ...
  // Results fade-in transition state
  ...
  const handleGenerate = async () => {
    ...
    // Scroll smoothly to results area immediately to display loading card
    setTimeout(() => {
    ...
    <div className="min-h-screen flex flex-col font-sans bg-[#FAF9F6] text-gray-900 selection:bg-amber-500/25 selection:text-amber-800 antialiased">
      ...
      <div className="fixed top-5 left-0 w-full px-4 z-50 flex justify-center">
        <nav className={`w-full max-w-4xl bg-white/80 backdrop-blur-xl border border-black/5 rounded-full px-6 py-3 flex justify-between items-center transition-all duration-300
          ...
          <div className="hidden md:flex items-center gap-8 text-xs font-bold tracking-wider uppercase text-gray-500">
            <a href="#how-it-works" className="hover:text-black transition-colors">How it works</a>
            <a href="#workspace" className="hover:text-black transition-colors">Workspace</a>
      ...
      <section className="text-center pt-40 pb-20 flex flex-col items-center justify-center relative overflow-hidden bg-[#FAF9F6]">
        ...
        <div className="px-6 max-w-4xl z-10">
          ...
          <button 
            onClick={scrollToUpload}
            className="bg-[#FFCE00] hover:bg-[#E5B800] text-gray-950 font-black px-8 py-4 rounded-full shadow-lg shadow-amber-500/20 transition-all hover:scale-[1.03] active:scale-98 flex items-center gap-1 group text-sm md:text-base mx-auto"
          >
        ...
        {/* 3D Convex Showcase Carousel with center line and perspective */}
        <div className="w-full relative mt-20 z-15 select-none overflow-hidden py-10 bg-black/[0.01] border-t border-b border-gray-200/50 perspective-container">
          ...
          <div className="relative w-full h-52 md:h-72 overflow-hidden flex justify-center items-center">
              ...
              <div className="absolute top-0 bottom-0 left-0 w-[200%] h-full">
                <div className="animate-marquee-right flex gap-4 md:gap-6 pr-4 md:pr-6 whitespace-nowrap h-full items-center">
                  {repeatedPairs.map((pair, index) => (
                    <div 
                      key={`left-${index}`} 
                      className="w-36 h-48 md:w-48 md:h-64 rounded-2xl md:rounded-[20px] overflow-hidden shadow-xl border border-black/5 shrink-0 select-none bg-gray-100"
                    >
                      <img 
                        src={pair.input} 
                        alt="Auralux AI Showcase Product Raw" 
            ...
            {/* Right Side: Final/Output Marquee (Right 50% window) with 3D Y-rotation meeting at the center line */}
                ...
                <div className="animate-marquee-right flex gap-4 md:gap-6 pr-4 md:pr-6 whitespace-nowrap h-full items-center">
                  {repeatedPairs.map((pair, index) => (
                    ...
                    >
                      <img 
                        src={pair.output} 
                        alt="Auralux AI Showcase Product Final" 
      ...
      {/* Section 3 - Interactive Timeline Workspace */}
        ...
        <div className="space-y-36 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative">
            ...
            <div className="md:pr-12 md:text-right order-2 md:order-1">
              ...
              <h3 className="text-2xl md:text-3xl font-black text-gray-900 mb-4">Choose from 9 high-converting styles</h3>
              <p className="text-gray-500 text-sm leading-relaxed max-w-md md:ml-auto">
                Ads, product catalogues, and lifestyle flat lays. Review each template's before and after reference layout side-by-side to select the ideal setting.
              </p>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                {templates
                  ...
                  .map(t => {
                    ...
                    const beforeImg = t.inputExample || "https://res.cloudinary.com/deijlb7dp/image/upload/q_auto/f_auto/v1780242141/Screenshot_2026-05-31_211148_n2d6sy.png";
                    return (
                      <div
                        key={t.id}
                      ...
                      >
                        ...
                        <div className="w-full aspect-[4/3] grid grid-cols-2 bg-gray-50 border-b border-gray-200/50 relative">
                          ...
                          <div className="w-full h-full relative overflow-hidden border-l border-gray-100">
                            <img src={t.thumbnail} alt="After preview" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                          </div>
                        </div>

                        {/* Details and Selection state */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start relative">
            ...
            <div className="md:pl-12 md:sticky md:top-32">
              ...
              <p className="text-gray-500 text-sm leading-relaxed max-w-md mb-6">
                You don't need to know how to prompt with AI. We do it for you. Click below to render your product into high-converting visual assets instantly.
              </p>
                    ...
                    return (
                      <button
                        ...
                        className={`py-2.5 px-1 rounded-xl text-[10px] font-black tracking-wider transition-all border text-center select-none
                          ${isSelected 
                            ? 'bg-[#FFCE00] text-gray-950 border-[#FFCE00] shadow-md shadow-amber-500/10 hover:scale-[1.01]' 
                ...
                <div className={`transform transition-all duration-500 ${showResults ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
                  ...
                  <div className="flex gap-4">
                    <button 
                      ...
                      className="flex-1 bg-[#FFCE00] hover:bg-[#E5B800] text-gray-950 font-extrabold py-3.5 rounded-[12px] text-sm flex items-center justify-center gap-2 transition-all shadow-md shadow-amber-500/10 hover:scale-[1.01]"
                    >
                  ...
                  <div className="mt-8 border-t border-gray-150 pt-6 text-center">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 bg-[#FFCE00] hover:bg-[#E5B800] text-gray-950 font-extrabold text-xs px-6 py-2.5 rounded-[10px] tracking-wide shadow-md transition-colors"
                    >
                      Contact on WhatsApp
                    </a>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch max-w-5xl mx-auto">
            ...
            <div className="bg-white border-2 border-[#FFCE00] shadow-[0_15px_30px_rgba(245,158,11,0.06)] rounded-3xl p-8 relative flex flex-col justify-between hover:scale-[1.02] transition-transform duration-300">
              ...
              <button
                type="button"
                onClick={scrollToUpload}
                className="w-full bg-[#FFCE00] hover:bg-[#E5B800] text-gray-950 font-black py-3.5 px-6 rounded-xl transition-all text-center text-sm shadow-md shadow-amber-500/10"
              >
                Choose Pro
              </button>
            </div>
